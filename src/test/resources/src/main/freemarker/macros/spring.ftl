 ...
 * some of the common requirements of ftl applications - in particular
 * handling of forms.
 *
 ...
 * adding the context root for the ftl application.
 -->
 ...
 * "defaultHtmlEscape" context-param in ftl.xml (same as for the JSP bind tag).
