...
public class PageCountLinesTest {
  ...
  public void testCountLines() throws FileNotFoundException {
    ...
    assertThat(ftlSourceCode.getMeasure(CoreMetrics.LINES).getIntValue()).isEqualTo(287);
    assertThat(ftlSourceCode.getMeasure(CoreMetrics.NCLOC).getIntValue()).isEqualTo(227);
    assertThat(ftlSourceCode.getMeasure(CoreMetrics.COMMENT_LINES).getIntValue()).isEqualTo(14);
  }
}
