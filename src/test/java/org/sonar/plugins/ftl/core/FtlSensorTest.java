 ...
 */
public class FtlSensorTest extends org.sonar.plugins.ftl.AbstractFtlPluginTester {

  private FtlSensor sensor;
  ...
  @Before
  public void setup() {
    sensor = new FtlSensor(new Ftl(new Settings()), createStandardRulesProfile(), new NoSonarFilter());
  }
  ...
  private Project loadProjectFromPom() throws Exception {
    ...
    project.setPom(pom);
    project.setLanguageKey(FtlConstants.LANGUAGE_KEY);
    project.setLanguage(new Ftl(new Settings()));
    ...
    when(projectFileSystem.mainFiles("ftl")).thenReturn(Lists.newArrayList(InputFileUtils.create(TestUtils.getResource("src/main/webapp"), "user-properties.jsp")));
    return project;
  }
