...
package org.sonar.plugins.ftl.its;
...
public class StandardMeasuresIT {
  ...
  private static final String PROJECT = "sonar.ftl:test";
  private static final String DIR_ROOT = "sonar.ftl:test:WEB-INF/jsp";
  private static final String FILE = "sonar.ftl:test:WEB-INF/jsp/admin/buildQueueView.jsp";
  ...
  public void projectsInfo() {
    assertThat(sonar.find(new ResourceQuery(PROJECT)).getName(), is("Test of Ftl Plugin"));
