 ...
 */
package org.sonar.plugins.ftl.checks.attributes;
...
public class IllegalAttributeCheckTest extends AbstractCheckTester {
  ...
  public void testAttributeCheck() {
    ...
    FtlSourceCode sourceCode = parseAndCheck(new StringReader(fragment), IllegalAttributeCheck.class, "attributes", "class");
