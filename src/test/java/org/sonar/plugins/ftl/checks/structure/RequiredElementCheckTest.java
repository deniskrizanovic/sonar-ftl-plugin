 ...
 */
package org.sonar.plugins.ftl.checks.structure;
...
public class RequiredElementCheckTest extends AbstractCheckTester {
  ...
  public void violateRequiredElement() throws FileNotFoundException {
    ...
    FtlSourceCode sourceCode = parseAndCheck(reader, RequiredElementCheck.class, "elements", "html,notfound1,notfound2");
