...
import org.sonar.plugins.ftl.checks.AbstractCheckTester;
...
public class UnifiedExpressionCheckTest extends AbstractCheckTester {
  ...
  public void violateUnifiedExpressionCheck() throws FileNotFoundException {
    ...
    FtlSourceCode sourceCode = parseAndCheck(reader, UnifiedExpressionCheck.class);
  ...
  public void testValidFunction() {
    ...
    StringReader reader = new StringReader(fragment);
    FtlSourceCode sourceCode = parseAndCheck(reader, UnifiedExpressionCheck.class, "functions", "align");
  ...
  public void testUnknownFunction() {
    ...
    String fragment = "<TD align=\"${testUI:align('inverse')}\">";
    StringReader reader = new StringReader(fragment);
    FtlSourceCode sourceCode = parseAndCheck(reader, UnifiedExpressionCheck.class, "functions", "another-function");
