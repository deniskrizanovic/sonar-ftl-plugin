 ...
 */
public class FtlRulesRepositoryTest extends org.sonar.plugins.ftl.AbstractFtlPluginTester {
  ...
  public void createSonarWayProfile() {
    ...
    assertThat(profile.getActiveRulesByRepository(FtlRulesRepository.REPOSITORY_KEY).size(), greaterThan(1));
    assertThat(validationMessages.hasErrors(), is(false));
  }

  @Test
  public void initializeWebRulesRepository() {
      FtlRulesRepository rulesRepository = new FtlRulesRepository(new AnnotationRuleParser());
  ...
  public void createChecks() {
    ...
    List<AbstractPageCheck> checks = FtlRulesRepository.createChecks(profile);
