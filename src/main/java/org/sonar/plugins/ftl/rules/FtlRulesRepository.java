...
/**
 * Repository for ftl rules.
 *
 * @author Matthijs Galesloot
 * @since 1.0
 */
public final class FtlRulesRepository extends RuleRepository {

  private static final Logger LOG = LoggerFactory.getLogger(FtlRulesRepository.class);

  public static final String REPOSITORY_NAME = "Ftl";
  public static final String REPOSITORY_KEY = "Ftl";
  private final AnnotationRuleParser annotationRuleParser;

  public FtlRulesRepository(AnnotationRuleParser annotationRuleParser) {
    super(REPOSITORY_KEY, FtlConstants.LANGUAGE_KEY);
