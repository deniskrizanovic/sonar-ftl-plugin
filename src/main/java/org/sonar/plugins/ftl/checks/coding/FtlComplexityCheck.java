 ...
 * @since 1.0
 */
@Rule(key = "FtlComplexityCheck", priority = Priority.MINOR)
public final class FtlComplexityCheck extends AbstractPageCheck {
  ...
  @RuleProperty
  private String[] tags = new String[] {"#if", "#else", "#elseif", "#switch", "#case", "#list"};
