...
/**
 * Checks and analyzers report measurements, violations and other findings in FtlSourceCode.
 *
 * @author Matthijs Galesloot
 * @since 1.0
 */
public class FtlSourceCode {
  ...
  public FtlSourceCode(Resource<?> resource) {
